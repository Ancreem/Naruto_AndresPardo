...
//        MisionNinja misionNinjaUpdate = new MisionNinja();
//        misionNinja.setMisionNinjaId(3);
//        MisionNinjaController.actualizarCompletadoId(misionNinjaUpdate);
//        MisionNinjaController.actualizarDisponibleId(misionNinjaUpdate);
